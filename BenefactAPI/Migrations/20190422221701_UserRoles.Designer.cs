...
namespace BenefactAPI.Migrations
{
    ...
    [Migration("20190422221701_UserRoles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BenefactAPI.Controllers.BoardRole", b =>
                {
                    b.Property<int>("BoardId")
                        .HasColumnName("board_id");
                    ...
                    b.HasIndex("Id")
                        .IsUnique()
                        .HasName("ix_board_role_id");

                    b.ToTable("board_role");
                });
            ...
            modelBuilder.Entity("BenefactAPI.Controllers.UserBoardRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("BenefactAPI.Controllers.BoardRole", b =>
                {
                    b.HasOne("BenefactAPI.Controllers.BoardData", "Board")
                        .WithMany("Roles")
                        .HasForeignKey("BoardId")
                        .HasConstraintName("fk_board_role_boards_board_id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BenefactAPI.Controllers.BoardData")
                        .WithOne("DefaultRole")
                        .HasForeignKey("BenefactAPI.Controllers.BoardRole", "Id")
                        .HasConstraintName("fk_board_role_boards_id")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("BenefactAPI.Controllers.CardData", b =>
                {
                    b.HasOne("BenefactAPI.Controllers.UserData", "Author")
            ...
            modelBuilder.Entity("BenefactAPI.Controllers.UserBoardRole", b =>
                {
                    b.HasOne("BenefactAPI.Controllers.BoardData", "Board")
                        .WithMany("Users")
                        .HasForeignKey("BoardId")
                        .HasConstraintName("fk_user_board_role_boards_board_id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BenefactAPI.Controllers.UserData", "User")
                        .WithMany("Roles")
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_user_board_role_users_user_id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BenefactAPI.Controllers.BoardRole", "BoardRole")
                        .WithMany("Users")
                        .HasForeignKey("BoardRoleBoardId", "BoardRoleId")
                        .HasConstraintName("fk_user_board_role_board_role_board_role_board_id_board_role_id");
                });
